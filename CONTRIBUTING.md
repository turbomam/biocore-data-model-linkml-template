# Contributing to biocore-data-model-linkml-template

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
biocore-data-model-linkml-template. These guidelines are not strict rules.
...
The biocore-data-model-linkml-template team strives to create a
...
[issues]: https://github.com/turbomam/biocore-data-model-linkml-template/issues/
[pulls]: https://github.com/turbomam/biocore-data-model-linkml-template/pulls/
